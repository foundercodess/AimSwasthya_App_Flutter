...
class DoctorSpecialisationModel {
  bool? status;
  Data? data;

  DoctorSpecialisationModel({this.status, this.data});

  DoctorSpecialisationModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
