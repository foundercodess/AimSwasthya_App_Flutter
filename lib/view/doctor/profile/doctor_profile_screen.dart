          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                ...
                hintText: docProfileCon.doctorProfileModel!.data!.doctors![0].doctorName??"Name",
              ...
              CustomTextField(
                ...
                hintText: docProfileCon.doctorProfileModel!.data!.doctors![0].gender??"Gender",
              ...
              CustomTextField(
                contentPadding:
                    const EdgeInsets.only(top: 18, bottom: 20, left: 10),
                fillColor: AppColor.textfieldGrayColor.withOpacity(0.4),
                hintText: docProfileCon.doctorProfileModel!.data!.doctors![0].phoneNumber.toString(),
              ...
              CustomTextField(
                contentPadding:
                    const EdgeInsets.only(top: 18, bottom: 20, left: 10),
                fillColor: AppColor.textfieldGrayColor.withOpacity(0.4),
                hintText: docProfileCon.doctorProfileModel!.data!.doctors![0].specializationName??"Specialization",
              ...
              CustomTextField(
                contentPadding:
                    const EdgeInsets.only(top: 18, bottom: 20, left: 10),
                fillColor: AppColor.textfieldGrayColor.withOpacity(0.4),
                hintText: docProfileCon.doctorProfileModel!.data!.doctors![0].experience??"Experience",
              ...
              CustomTextField(
                contentPadding:
                    const EdgeInsets.only(top: 18, bottom: 20, left: 10),
                fillColor: AppColor.textfieldGrayColor.withOpacity(0.4),
                hintText: docProfileCon.doctorProfileModel!.data!.clinics![0].name??"Clinic name",
              ...
              CustomTextField(
                contentPadding:
                    const EdgeInsets.only(top: 18, bottom: 20, left: 10),
                fillColor: AppColor.textfieldGrayColor.withOpacity(0.4),
                hintText: docProfileCon.doctorProfileModel!.data!.clinics![0].address??"Address",
              ...
              CustomTextField(
                contentPadding:
                    const EdgeInsets.only(top: 18, bottom: 20, left: 10),
                fillColor: AppColor.textfieldGrayColor.withOpacity(0.4),
                hintText: docProfileCon.doctorProfileModel!.data!.clinics![0].phoneNumber??"Contact no",
                keyboardType: TextInputType.number,
              ...
              CustomTextField(
                contentPadding:
                    const EdgeInsets.only(top: 18, bottom: 20, left: 10),
                fillColor: AppColor.textfieldGrayColor.withOpacity(0.4),
                hintText:docProfileCon.doctorProfileModel!.data!.clinics![0].landmark?? "Landmark (optional)",
        ...
        children: [
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: docProfileCon.doctorProfileModel!.data!.doctors![0]
                        ...
                        : const AssetImage(Assets.imagesDoctorImg),
          ...
          Column(
            ...
            children: [
              ...
              Sizes.spaceHeight3,
              TextConst(
                "${docProfileCon.doctorProfileModel!.data!.doctors![0].qualification} (${docProfileCon.doctorProfileModel!.data!.doctors![0].specializationName})",
