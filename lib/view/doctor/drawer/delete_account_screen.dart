    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          Sizes.spaceHeight15,
          Container(
            margin:  EdgeInsets.only(left: Sizes.screenWidth*0.05, right: Sizes.screenWidth*0.05),
            ...
            child: Column(
              ...
              children: [
                ...
                const Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                          text: "certain transactional data may be retained in accordance with medical and legal regulations.",
                          style: TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.w400,
                            fontFamily: 'Poppins-Bold',
                ...
                }, title: 'Delete your account',color: Color(0xffC10000),),
                Sizes.spaceHeight10,
              ],
            ),
          )
