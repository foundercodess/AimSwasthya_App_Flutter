// patient_section/view/p_drawer/wellness/wellness_library_screen.dart
import 'dart:ui';
        ...
        child: Column(
          ...
          children: [
            ...
            (healthTipCon.getWellnessLibraryModel == null ||
                    healthTipCon.getWellnessLibraryModel!.data == null)
                ? Container(
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final items =
                          healthTipCon.getWellnessLibraryModel!.data![index];
                      return Padding(
                        padding:
                            EdgeInsets.only(bottom: Sizes.screenHeight * 0.025),
                        child: ClipRRect(
